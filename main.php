...
<div class="container">
    ...
    <a href="#" class="logo">Accident Health Centre</a>
...
<div class="container">
    ...
    <div class="row min-vh-100 align-items-center text-center text-md-left">
        ...
        <div class="col-md-6 pl-md-5 content" data-aos="fade-left">
            ...
            <a href="covid.php"><button class="button">Covid-19</button></a>
        </div>
...
<div class="container">
    ...
    <h1 class="heading"><span>'</span> Regular Services <span>'</span></h1>
